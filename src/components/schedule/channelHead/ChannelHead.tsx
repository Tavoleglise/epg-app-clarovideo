...
const ChannelHead: React.FC<ChannelHeadProps> = ({ channel }) => {
  return (
    <div className="flex justify-center items-center p-4 w-64 h-32 bg-gray-900/50 text-gray-300 backdrop-blur border border-white border-opacity-25 shadow-right z-10">
      <div className="w-32">
        <Image
      ...
      <div className="w-32 h-full flex text-2xl justify-end items-start">
        {channel.number}
      </div>
    </div>
  );
